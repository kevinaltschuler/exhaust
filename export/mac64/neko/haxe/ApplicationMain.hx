...
class ApplicationMain {
	...
	public static function main () {
		...
		flash.Lib.setPackage ("HaxeFlixel", "Exhaust", "com.example.myapp", "0.0.1");
		...
		telemetryConfig.app_name = "Exhaust";
		#end
...
class ApplicationMain {
	...
	public static function main () {
		...
		wx.App.boot (function () {
			...
			frame = wx.Frame.create (null, null, "Exhaust", null, { width: 640, height: 480 });
